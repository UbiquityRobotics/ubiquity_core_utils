...
def generate_launch_description():
    ...
    odom_node = Node(
        ...
        output='screen',
        condition=IfCondition(EqualsSubstitution(LaunchConfiguration('generation'), 'gen6'))
    )
    ...
    twist_bridge_node = Node(
        ...
        name='twist_bridge',
        output='screen',
        condition=IfCondition(EqualsSubstitution(LaunchConfiguration('generation'), 'gen5'))
    )    
